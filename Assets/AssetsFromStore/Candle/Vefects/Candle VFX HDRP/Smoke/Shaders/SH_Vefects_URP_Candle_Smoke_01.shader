...
Shader "Vefects/SH_Vefects_URP_Candle_Smoke_01"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _TextureColorIntensity;
			float _EmissiveMultiply;
			float _Eros;
			float _ErosSmooth;
			float _VerticalOpacityPosition;
			float _VerticalOpacityFalloff;
			float _VerticalBotOpacityPosition;
			float _VerticalBotOpacityFalloff;
					...
					)
			{
				...
				float2 texCoord23 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner59 = ( 1.0 * _Time.y * _SmokeUVPan + ( texCoord23 * _SmokeUVScale ));
				float randomOffset44 = packedInput.ase_texcoord1.z;
				...
				float4 lerpResult86 = lerp( packedInput.ase_color , ( packedInput.ase_color * float4( tex2DNode10.rgb , 0.0 ) ) , _TextureColorIntensity);
				
				float3 temp_cast_3 = (_Eros).xxx;
				float3 temp_cast_4 = (( _Eros + _ErosSmooth )).xxx;
				float3 smoothstepResult61 = smoothstep( temp_cast_3 , temp_cast_4 , tex2DNode10.rgb);
				float2 texCoord69 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult71 = smoothstep( _VerticalOpacityPosition , ( _VerticalOpacityPosition + _VerticalOpacityFalloff ) , ( 1.0 - texCoord69.y ));
				float2 texCoord80 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult79 = smoothstep( _VerticalBotOpacityPosition , ( _VerticalBotOpacityPosition + _VerticalBotOpacityFalloff ) , texCoord80.y);
				
				surfaceDescription.Color = lerpResult86.rgb;
				surfaceDescription.Emission = ( lerpResult86 * _EmissiveMultiply ).rgb;
				surfaceDescription.Alpha = saturate( ( saturate( ( saturate( smoothstepResult61 ) * saturate( ( saturate( smoothstepResult71 ) * saturate( smoothstepResult79 ) ) ) ) ) * packedInput.ase_color.a ) ).x;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 panner59 = ( 1.0 * _Time.y * _SmokeUVPan + ( texCoord23 * _SmokeUVScale ));
				float randomOffset44 = packedInput.ase_texcoord2.z;
				float2 appendResult105 = (float2(0.0 , randomOffset44));
				...
				float3 temp_cast_4 = (( _Eros + _ErosSmooth )).xxx;
				float3 smoothstepResult61 = smoothstep( temp_cast_3 , temp_cast_4 , tex2DNode10.rgb);
				float2 texCoord69 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult71 = smoothstep( _VerticalOpacityPosition , ( _VerticalOpacityPosition + _VerticalOpacityFalloff ) , ( 1.0 - texCoord69.y ));
				float2 texCoord80 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult79 = smoothstep( _VerticalBotOpacityPosition , ( _VerticalBotOpacityPosition + _VerticalBotOpacityFalloff ) , texCoord80.y);
		...
		Pass
		{
					...
					)
			{
				...
				BuiltinData builtinData;
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 temp_cast_0 = (_Eros).xxx;
				float3 temp_cast_1 = (( _Eros + _ErosSmooth )).xxx;
				float2 texCoord23 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner59 = ( 1.0 * _Time.y * _SmokeUVPan + ( texCoord23 * _SmokeUVScale ));
				float randomOffset44 = packedInput.ase_texcoord.z;
				float2 appendResult105 = (float2(0.0 , randomOffset44));
				float2 texCoord14 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * _DistortionUVPan + ( texCoord14 * _DistortionUVScale ));
				float2 texCoord28 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult29 = smoothstep( _VerticalDistortionPosition , ( _VerticalDistortionPosition + _VerticalDistortionFalloff ) , texCoord28.y);
				float2 lerpResult21 = lerp( float2( 0,0 ) , ( ( (tex2D( _DistortionTexture, ( panner17 + randomOffset44 ) ).rgb).xy + -0.5 ) * 2.0 ) , saturate( ( _DistortionIntensity * saturate( smoothstepResult29 ) ) ));
				float4 tex2DNode10 = tex2D( _SmokeTexture, ( ( panner59 + appendResult105 ) + lerpResult21 ) );
				float3 smoothstepResult61 = smoothstep( temp_cast_0 , temp_cast_1 , tex2DNode10.rgb);
				float2 texCoord69 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult71 = smoothstep( _VerticalOpacityPosition , ( _VerticalOpacityPosition + _VerticalOpacityFalloff ) , ( 1.0 - texCoord69.y ));
				float2 texCoord80 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult79 = smoothstep( _VerticalBotOpacityPosition , ( _VerticalBotOpacityPosition + _VerticalBotOpacityFalloff ) , texCoord80.y);
		...
		Pass
		{
					...
					)
			{
				...
				float2 panner59 = ( 1.0 * _Time.y * _SmokeUVPan + ( texCoord23 * _SmokeUVScale ));
				float randomOffset44 = packedInput.ase_texcoord3.z;
				float2 appendResult105 = (float2(0.0 , randomOffset44));
				...
				float4 tex2DNode10 = tex2D( _SmokeTexture, ( ( panner59 + appendResult105 ) + lerpResult21 ) );
				float3 smoothstepResult61 = smoothstep( temp_cast_0 , temp_cast_1 , tex2DNode10.rgb);
				float2 texCoord69 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult71 = smoothstep( _VerticalOpacityPosition , ( _VerticalOpacityPosition + _VerticalOpacityFalloff ) , ( 1.0 - texCoord69.y ));
				float2 texCoord80 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult79 = smoothstep( _VerticalBotOpacityPosition , ( _VerticalBotOpacityPosition + _VerticalBotOpacityFalloff ) , texCoord80.y);
...
Node;AmplifyShaderEditor.Vector2Node;16;-3712,768;Inherit;False;Property;_DistortionUVScale;Distortion UV Scale;8;0;Create;True;0;0;0;False;0;False;0.1,0.1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RegisterLocalVarNode;44;-1024,-1152;Inherit;False;randomOffset;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;18;-3328,768;Inherit;False;Property;_DistortionUVPan;Distortion UV Pan;9;0;Create;True;0;0;0;False;0;False;-0.03,-0.2;-0.03,-0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-1664,1152;Inherit;False;Property;_VerticalDistortionPosition;Vertical Distortion Position;11;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-1664,1280;Inherit;False;Property;_VerticalDistortionFalloff;Vertical Distortion Falloff;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;57;-3328,128;Inherit;False;Property;_SmokeUVScale;Smoke UV Scale;5;0;Create;True;0;0;0;False;0;False;1,0.2;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;58;-2944,128;Inherit;False;Property;_SmokeUVPan;Smoke UV Pan;6;0;Create;True;0;0;0;False;0;False;0,-0.2;0,-0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-1664,1920;Inherit;False;Property;_VerticalOpacityPosition;Vertical Opacity Position;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;68;-1664,2048;Inherit;False;Property;_VerticalOpacityFalloff;Vertical Opacity Falloff;14;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-1664,2560;Inherit;False;Property;_VerticalBotOpacityFalloff;Vertical Bot Opacity Falloff;16;0;Create;True;0;0;0;False;0;False;0.2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-1664,2432;Inherit;False;Property;_VerticalBotOpacityPosition;Vertical Bot Opacity Position;15;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-768,512;Inherit;False;Property;_Eros;Eros;17;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;64;-768,640;Inherit;False;Property;_ErosSmooth;Eros Smooth;18;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;10;-1408,0;Inherit;True;Property;_SmokeTexture;Smoke Texture;4;0;Create;True;0;0;0;False;3;Space(33);Header(Smoke);Space(13);False;-1;66fecea9ea01c0f4d94abda6fed2878a;66fecea9ea01c0f4d94abda6fed2878a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;157;1;41;0
WireConnection;157;2;102;0
ASEEND*/
//CHKSM=9D0D0328BCA412D0403B8A06D3820ADFF2513CF6